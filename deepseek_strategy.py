...
class Intraday15MinStrategy:
    ...
    def backtest_on_signals(self, df, signals):
        ...
        CHECKPOINT_STEP_PCT = 0.5 / 100   # 0.5% (for checkpoint and stop adjustment)
        THRESHOLDS_PCT = [0.7 / 100, 1.4 / 100, 2.1 / 100, 2.8 / 100, 3.5 / 100]  # step up every 0.7%
        # If you want to adjust, change above lists.
