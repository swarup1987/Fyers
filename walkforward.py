...
class WalkForwardBacktester:
    def __init__(self, strategy_key, interval, symbol, capital=10000):
        """
    ...
    def run_backtest(self):
        ...
        for idx, (train_df, test_df, train_start, test_start) in enumerate(windows):
            ...
            # "Fit" on train_df if needed (for ML/param search, not used here)
            # For rule-based: just use on test_df

            # --- Run signals on test_df ---
